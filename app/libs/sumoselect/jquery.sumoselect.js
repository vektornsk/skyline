...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            captionFormatAllSelected:'{0} Все!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
